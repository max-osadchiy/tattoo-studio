    ...
    return (
        <div>
            <div className="first-block">
                ...
                <img style={{ position: 'absolute', left: '530px', top: 0 }} src={rect} alt=""/>
                <div>
            ...
            <div className="second-block">
                ...
                <ServicesBlock />
                <img style={{ position: 'absolute', left: '-5px', top: '338px' }} src={rect} alt=""/>
                <img style={{ position: 'absolute', left: '809px', top: '-120px' }} src={rect} alt=""/>
                <img style={{ position: 'absolute', left: '650px', top: '763px' }} src={rect} alt=""/>
                <img style={{ position: 'absolute', right: '-24px', top: '600px' }} src={rect} alt=""/>
            </div>
