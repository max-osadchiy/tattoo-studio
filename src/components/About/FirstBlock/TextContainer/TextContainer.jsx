    ...
    return (
        <div className="a-text-container">
            <div className="a-text-block">
                ...
                <p>tattoo, piercing. We are focused on a high-quality result, and therefore we have selected a team of professionals for you. Our studio uses only the best, modern equipment and supplies.</p>
